...
public class DriveSubsystem extends Subsystem {
  ...
  //      SmartDashboard.putNumber("rightsideEncoder", RobotMap.rightsideEncoder.getPosition());
   //     SmartDashboard.putNumber("rightsideEncoderInFeet", getRightSideDistance());
    ...
    public double ticsToFeet(double tics) { 
    ...
    public double getRealAngle(){
        if (ahrsIsConnected()) {
			return ahrs.getAngle() - initialAngle; //Angle direction was opposite of 2017 testing (raw is clockwise-positive, corrected is clockwise-negative)
		} else {
			complainAboutMissingAhrs();
			return 0;
		}
